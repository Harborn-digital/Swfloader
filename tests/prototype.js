 ...
 * applyWithTimeout
 *
 * Applies a function with a timeout and binds object to the function
 *
 ...
 * applyWithInterval
 *
 * Applies a function with an interval and binds object to the function
 *
 * @since Fri May 04 2007
 * @access public
 * @param object object
 ...
 **/
Function.prototype.applyWithInterval = function() {
	var __method = this, args = $A(arguments), object = args.shift(), interval = args.shift();
	__intervalmethod = function() {
		return __method.apply(object, args.concat($A(arguments)));
	}
	return setInterval(__intervalmethod, interval);
}
...
// Add viewPortDimensions.width and height to window
