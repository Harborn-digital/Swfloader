 ...
 *
 */
class WMExpressInstallTest {
	
	private static var instance:WMExpressInstallTest;
	private var updater:MovieClip;
	private var hold:MovieClip;
	
	function ExpressInstall() {}
	
	public static function getInstance():WMExpressInstallTest {
		if (instance == undefined) {
			instance = new WMExpressInstallTest();
		}
		return instance;
	}
	...
	public function loadUpdater():Void {
		...
		hold.loadMovie("http://fpdownload.adobe.com/pub/flashplayer/update/current/swf/autoUpdater.swf?"+ cacheBuster);
	}
