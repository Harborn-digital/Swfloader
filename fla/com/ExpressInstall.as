...
class com.ExpressInstall {
	...
	public function loadUpdater():Void {
		...
		updater = _root.createEmptyMovieClip("expressInstallHolder", 10000007);
	...
	private function onInstallStatus(msg):Void {
		if (msg == "Download.Complete") {
			...
			getURL("javascript:swfloader.addAlternateContentCallback('" + _root.SWFContainer + "', " + Stage.width + ", " + Stage.height + ");");
